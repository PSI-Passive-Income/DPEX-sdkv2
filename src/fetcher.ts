...
import IDPexPair from '@passive-income/dpex-swap-core/abi/contracts/interfaces/IDPexPair.sol/IDPexPair.json'
...
export abstract class Fetcher {
  ...
  public static async fetchPairData(
    ...
    const [reserves0, reserves1] = await new Contract(address, IDPexPair, provider).getReserves()
