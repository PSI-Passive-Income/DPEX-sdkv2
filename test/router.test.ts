...
describe('Router', () => {
  ...
  const factory = "0x92Be203e0dfb40c1a1F937a36929E02856257A2e"
    ...
    describe('exact in', () => {
      it('ether to token1', () => {
        const result = Router.swapCallParameters(
          ...
          { factory: factory, ttl: 50, recipient: '0x0000000000000000000000000000000000000004', allowedSlippage: new Percent('1', '100') }
        )
